...
Initial v2.1 release using generalised considerationAttributes container.
...
- Per-schema prefix pointing to `https://schema.beckn.io/CourseConsideration#`
